...
# sprawdzenie ostatniej paczki odnośnie pustego miejsca + weryfikacja czy nie jest ono największe
if puste_miejsce > max_puste_miejsce:
    max_puste_miejsce = puste_miejsce
    nr_paczki_puste_miejsce = l_paczek
...
print(f"Sumaryczna waga wszystkich paczek: {waga_sum} kg")
print(f"Najwięcej pustego miejsca jest w paczce nr {nr_paczki_puste_miejsce}")
print(f"Zostało w niej {max_puste_miejsce} kg")
